...
# 기존 이미지 및 라벨 저장 폴더
label_source_root = "./apt/data/real_data/val/labels"
image_source_root = "./apt/data/ILSVRC2015/Data/VID/val"
output_dir = "./apt/data/real_data/val/img"  # 640x640 변환된 이미지 저장 폴더
