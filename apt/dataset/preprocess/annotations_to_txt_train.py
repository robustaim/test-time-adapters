...
# 데이터 경로 설정
annotations_root = "/shared_hdd/annasdfghjkl13/APT/data/ILSVRC2015/Annotations/VID/train"  # XML 파일이 저장된 최상위 폴더
output_dir = "/shared_hdd/annasdfghjkl13/APT/data/my_data/train/labels"  # YOLO 라벨 저장 폴더
